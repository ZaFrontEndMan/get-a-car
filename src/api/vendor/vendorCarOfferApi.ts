...
export const createCarOffer = async (offerData: any) => {
  const { data } = await axiosInstance.post(
    "/Vendor/CarOffer/CreateCarOffer",
    offerData
  );
  return data;
};
...
export const getCarOfferById = async (offerId: string) => {
  const { data } = await axiosInstance.get(
    `/Vendor/CarOffer/GetCarOfferById/${offerId}`
  );
  return data;
};
...
export const deleteCarOffer = async (offerId: string) => {
  const { data } = await axiosInstance.delete(
    `/Vendor/CarOffer/DeleteCarOffer?offerId=${offerId}`
  );
  return data;
};
...
export const getOfferForCar = async (carId: string) => {
  const { data } = await axiosInstance.get(
    `/Vendor/CarOffer/GetOfferForCar/${carId}`
  );
  return data;
};
