...
const AdminDashboardLayout = ({ children, activeTab, onTabChange }: AdminDashboardLayoutProps) => {
  const { user } = useAuth();
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-indigo-50/20" dir={isRTL ? 'rtl' : 'ltr'}>
      <AdminHeader 
        user={user}
      ...
      <div className="flex pt-16">
        ...
        <main className={`flex-1 transition-all duration-300 ease-in-out min-h-[calc(100vh-64px)] ${
          ...
          <div className="relative">
              ...
              <div className="max-w-7xl mx-auto">
                ...
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-200/60 min-h-[calc(100vh-200px)] overflow-hidden">
                  ...
                  <div className="p-6 lg:p-8">
                    <div className={`${isRTL ? 'text-right font-arabic' : 'text-left'} space-y-6`}>
            ...
            <div className={`fixed bottom-8 ${isRTL ? 'left-8' : 'right-8'} pointer-events-none`}>
