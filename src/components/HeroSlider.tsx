  ...
  const fallbackSlides = [
    {
      ...
      subtitle: t('heroSlider.slide1.subtitle') || 'Experience luxury and comfort with our premium fleet',
    ...
    },
    {
      ...
      subtitle: t('heroSlider.slide2.subtitle') || 'Find amazing deals on top-rated vehicles',
    ...
    },
    {
      ...
      subtitle: t('heroSlider.slide3.subtitle') || 'Join thousands of satisfied customers',
    ...
    <section className="relative h-[70vh] md:h-[80vh] overflow-hidden bg-gradient-to-br from-gray-900 to-gray-700">
      ...
      {displaySlides.map((slide, index) => (
        ...
        >
          <img
            src={slide.image_url}
            alt={language === 'ar' && slide.title_ar ? slide.title_ar : slide.title}
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              {displaySlides[currentSlide]?.button_text && (
                <Button 
                  ...
                  onClick={() => handleButtonClick(displaySlides[currentSlide]?.button_url)}
                >
                  {language === 'ar' && displaySlides[currentSlide]?.button_text_ar 
              ...
              >
                {t('common.browseVendors') || 'Browse Vendors'}
              </Button>
            </div>
          </div>
        </div>
