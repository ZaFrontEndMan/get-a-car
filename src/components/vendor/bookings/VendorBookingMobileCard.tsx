...
const VendorBookingMobileCard = ({ booking }: VendorBookingMobileCardProps) => {
  ...
  const getStatusConfig = (status: string) => {
    switch (status.toLowerCase()) {
      case 'pending':
        return { color: 'bg-yellow-500', textColor: 'text-yellow-700', bgColor: 'bg-yellow-50', label: 'Pending', icon: Clock };
      case 'confirmed':
        return { color: 'bg-blue-500', textColor: 'text-blue-700', bgColor: 'bg-blue-50', label: 'Confirmed', icon: CheckCircle };
      case 'active':
      case 'in_progress':
        return { color: 'bg-green-500', textColor: 'text-green-700', bgColor: 'bg-green-50', label: 'Active', icon: CheckCircle };
      case 'completed':
        return { color: 'bg-gray-500', textColor: 'text-gray-700', bgColor: 'bg-gray-50', label: 'Completed', icon: CheckCircle };
      case 'cancelled':
        return { color: 'bg-red-500', textColor: 'text-red-700', bgColor: 'bg-red-50', label: 'Cancelled', icon: XCircle };
      case 'return_requested':
        return { color: 'bg-orange-500', textColor: 'text-orange-700', bgColor: 'bg-orange-50', label: 'Return Requested', icon: AlertCircle };
      default:
        return { color: 'bg-gray-400', textColor: 'text-gray-700', bgColor: 'bg-gray-50', label: status, icon: Clock };
    }
  };
