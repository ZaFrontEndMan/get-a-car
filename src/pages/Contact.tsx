                  ...
                  <div className="space-y-4">
                    <div className="flex items-start space-x-4 rtl:space-x-reverse">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">{settings?.address || '123 King Fahd Road, Riyadh 12345, Saudi Arabia'}</p>
                        <p className="text-gray-600">{settings?.city}, {settings?.country}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-4 rtl:space-x-reverse">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">{settings?.supportPhone || '+966 11 123 4567'}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-4 rtl:space-x-reverse">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">{settings?.contactEmail || 'info@getcar.sa'}</p>
                      </div>
                    </div>
