...
export const arTranslations = {
  ...
  aboutUsDescription: 'نحن شركة رائدة في مجال تأجير السيارات في المملكة العربية السعودية، نقدم خدمات متميزة وأسطولاً حديثاً من السيارات لتلبية احتياجاتكم المختلفة.',
  ourMission: 'رسالتنا',
  missionText: 'تقديم خدمات تأجير سيارات عالية الجودة مع التركيز على رضا العملاء والسلامة والراحة.',
  ourVision: 'رؤيتنا',
  visionText: 'أن نكون الخيار الأول لتأجير السيارات في المنطقة من خلال الابتكار والتميز في الخدمة.',
  ourValues: 'قيمنا',
  ...
  testimonialsDescription: 'اسمع ما يقوله عملاؤنا عن تجربتهم مع خدمة تأجير السيارات لدينا',
